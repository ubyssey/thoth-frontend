export async function load() {
    console.log("hello?");
    const url = "http://thothbackend:8000/api/tags/?is_root=true&format=json";
    try {
...
export const actions = {
    create: async({fetch, request}) => {
        ...
        const login_api_url = "http://thothbackend:8000/api/tags/";
        try {
    ...
    delete: async({fetch, request}) => {
        ...
        const login_api_url = "http://thothbackend:8000/api/tags/" + data.get("id") + "/";
        try {
    ...
    add_domain_to_tag: async({fetch, request}) => {
        ...
        console.log(data);
        const add_domain_api_url = "http://thothbackend:8000/api/tags/domains/";
