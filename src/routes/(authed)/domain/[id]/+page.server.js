...
export async function load({params}) {
    console.log("hello?");
    const webpages_api_url = "http://thothbackend:8000/api/webpages/?domain_id=" + params.id + "&format=json";
    const domain_api_url = "http://thothbackend:8000/api/domains/" + params.id + "?format=json";
